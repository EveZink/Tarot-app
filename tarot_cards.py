...
# Sukuriame kortų ir jų reikšmių žodyną
tarot_cards_meanings = {
    ...
    'Vyriausioji žynė': {'reiksme': 'Intuicija, įžvalgos', 'aprasymas': 'Tu tai turi- tikėk intuicija ir vidaus balsu.',
                         'patarimas': 'Sek savo vidiniu balsu', 'paveikslelis': 'images/Vyriausioji žynė.jpg'},
    'Imperatorė': {'reiksme': 'Kūryba, vaisingumas, gausa', 'aprasymas': 'Galinga, įtakinga, mylinti ir besirūpinanti',
                   'patarimas': 'Rūpinkis savimi ir aplinkiniais', 'paveikslelis': 'images/Imperatorė.jpg'},
    ...
    'Šventikas': {'reiksme': 'Tradiciškumas, išmintis, mokymas', 'aprasymas': 'Tavęs laukia apeigos arba mokymai',
                  'patarimas': 'Semkis išminties iš praeities', 'paveikslelis': 'images/Šventikas.jpg'},
    ...
    'Vežimas': {'reiksme': 'Kontrolė, valia, pergale.', 'aprasymas': 'Progresas tavo pusėje - viskas eina į gerą',
                'patarimas': 'Eik tiesiai į tikslą.', 'paveikslelis': 'images/Vežimas.jpg'},
    ...
    'Fortūnos ratas': {'reiksme': 'Sėkmė, pokytis, ciklai.',
                       ...
                       'patarimas': 'Viskas keičiasi – būk pasiruošęs.', 'paveikslelis': 'images/Fortūnos ratas.jpg'},
    ...
    'Bokštas': {'reiksme': 'Staigūs pokyčiai, griuvimas, tiesa.',
                ...
                'patarimas': 'Kas griūna, padaro vietos naujam.', 'paveikslelis': 'images/Bokštas.jpg'},
...
def draw_card():
    ...
    # Pridėti tekstą prie paveikslėlio
    ...
    # Rodyti paveikslėlį Tkinter lange
    combined_img.thumbnail((400, 600))  # Sumažinti paveikslėlį
